...
namespace Dialogue.Domain.Infrastructure
{
    public class IncControllerFactory : DefaultControllerFactory
    {
        ...
        {
            return controllerType == null ? base.GetControllerInstance(requestContext, controllerType) : IoCFactory.Instance.Resolve<IController>(controllerType);
        }
    }
        ...
        public static void InitializeContainer()
        {
            ...
            IoCFactory.Instance.Initialize(init => init.WithProvider(new StructureMapIoCProvider(r =>
            {
                ...
                r.Scan(rg =>
                {
                    ...
                    rg.Assembly("Dialogue");
                    rg.Assembly("Dialogue.Domain");
                });
            })));
        }
    }
